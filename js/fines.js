...
function classifyFineIssuer(f) {
  ...
  if (s.includes('нпс') || s.includes('сержант') || s.includes('лейтенант') || s.includes('капітан')
    || s.includes('патруль') || s.includes('кадет')) return { icon: '<svg width="16" height="16" style="vertical-align:text-bottom" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3v-1z"/><path d="M4 12l2-7a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2l2 7"/><path d="M10 6v2a2 2 0 0 0 4 0V6h-4z"/></svg>', label: f.issuer || 'НПС' };
